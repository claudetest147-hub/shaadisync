...
CREATE TABLE guests (
  ...
  email TEXT,
  phone TEXT,
  group_name TEXT, -- 'Family', 'Friends', 'Coworkers', etc.
...
CREATE TABLE rsvps (
  ...
  guest_email TEXT, -- For public RSVPs without guest_id
  guest_name TEXT,
...
-- Allow public RSVP submissions (no auth required for public events)
...
CREATE TABLE vendors (
  ...
  name TEXT NOT NULL,
  category TEXT NOT NULL, -- 'photographer', 'caterer', 'venue', 'decorator', 'mehendi', 'dj', etc.
  description TEXT,
  contact_name TEXT,
  email TEXT,
  phone TEXT,
...
-- ============================================================================
-- EVENT VENDORS (Hired Vendors)
-- ============================================================================
CREATE TABLE event_vendors (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
  event_id UUID REFERENCES events(id) ON DELETE CASCADE NOT NULL,
  vendor_id UUID REFERENCES vendors(id) ON DELETE CASCADE,
  vendor_name TEXT, -- For custom vendors not in the directory
...
CREATE TABLE checklist_items (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
  event_id UUID REFERENCES events(id) ON DELETE CASCADE NOT NULL,
  category TEXT, -- 'venue', 'catering', 'attire', 'decorations', etc.
  title TEXT NOT NULL,
  description TEXT,
